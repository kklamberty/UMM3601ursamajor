...
Submission.find({}).remove(function(){
    Submission.create({
        ...
        otherInfo: "",
        approval: true,
        status:  {strict: "Reviewing in Process", text: "Has not been reviewed yet"},
        ...
        otherInfo: "",
        approval: true,
        status: {strict: "Needs Revisions", text: "Submitter is working on updating"},
        ...
        otherInfo: "yes.",
        approval: true,
        status: {strict: "Needs Revisions", text: "Needs to be updated an iota"},
        ...
        otherInfo: "Maybe",
        approval: true,
        status: {strict: "Reviewing in Process", text: "Not all reviewers have had a chance to look at it yet"},
        timestamp: "Mon Oct 20 2014 1:48:54 GMT-0500 (CDT)",
        reviewers: ["reviewer@reviewer.com"]
    });
});